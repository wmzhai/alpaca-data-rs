...
- 当前真正落地的共享层能力已覆盖 builder/runtime config、认证配对校验、配置错误建模、基础 query 序列化、最小 endpoint 路由、最小 async HTTP transport、共享分页 helper，以及真实 API 下的 `crypto.latest_quotes` canary 验证。
