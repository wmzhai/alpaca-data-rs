...
- 这是一个新项目，当前已经完成 `Phase 1: Shared Core`、`Phase 2: Stocks`、`Phase 3: Options`、`Phase 4: Crypto` 与 `Phase 5: News + Corporate Actions`，当前工作版本是 `v0.5.1`。
...
- 下一步默认进入 `Phase 6: Release Hardening`，集中补公开英文文档、examples、rustdoc、API coverage contract、API sync skill、package metadata 与预发布验证。
