...
- 这是一个新项目，当前已经完成 `Phase 1: Shared Core`、`Phase 2: Stocks`、`Phase 3: Options` 与 `Phase 4: Crypto`，当前工作版本是 `v0.4.0`。
...
- 当前下一步进入 `Phase 5: News + Corporate Actions`，继续沿用 `stocks` / `options` / `crypto` 已经定型的资源模块模板、live test、mock fault 与 benchmark 收尾结构。
