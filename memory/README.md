...
- 这是一个新项目，当前已经完成 `Phase 1: Shared Core`、`Phase 2: Stocks` 与 `Phase 3: Options`，`Phase 4: Crypto` 的功能面已经完成，当前工作版本是 `v0.3.3`。
...
- 当前下一步进入 `Phase 4: Crypto` 的 benchmark、文档收尾、MINOR 版本升级与主干合并，继续沿用 `stocks` / `options` 已经定型的 phase 收尾结构。
