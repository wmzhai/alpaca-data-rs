...
pub struct ForwardSplit {
    ...
    pub symbol: String,
    pub cusip: String,
    pub new_rate: rust_decimal::Decimal,
    pub old_rate: rust_decimal::Decimal,
...
pub struct UnitSplit {
    ...
    pub alternate_rate: rust_decimal::Decimal,
    pub process_date: String,
...
pub struct SpinOff {
    ...
    pub source_rate: rust_decimal::Decimal,
    pub new_symbol: String,
    pub new_cusip: String,
    pub new_rate: rust_decimal::Decimal,
    pub process_date: String,
...
pub struct StockMerger {
    ...
    pub acquirer_rate: rust_decimal::Decimal,
    pub acquiree_symbol: String,
    pub acquiree_cusip: String,
    pub acquiree_rate: rust_decimal::Decimal,
    pub process_date: String,
    pub effective_date: String,
    pub payable_date: Option<String>,
}
...
pub struct StockAndCashMerger {
    ...
    pub acquiree_cusip: String,
    pub acquiree_rate: rust_decimal::Decimal,
    pub cash_rate: rust_decimal::Decimal,
    pub process_date: String,
    pub effective_date: String,
    pub payable_date: Option<String>,
}
